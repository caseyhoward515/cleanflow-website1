...
| `assets/brand/cleanflow-favicon-master.png` | PNG, 512x512 | ~237 KB | **Exact deterministic crop of owner-approved CleanFlow artwork** from `assets/og-image-v2.png`; no logo or mascot redraw. Master source for the site's favicon family. | Favicon source master; not referenced directly by page markup |
| `assets/brand/favicon-96x96.png` | PNG, 96x96 | ~16 KB | Downscaled from the exact approved favicon master with no redraw. | Explicit 96x96 browser and search favicon on every public page |
| `favicon.ico` | ICO, 48x48, 32x32, 16x16 | ~15 KB | Multi-resolution favicon generated from the exact approved favicon master with no redraw. | Root fallback favicon on every public page |
| `apple-touch-icon.png` | PNG, 180x180 | ~47 KB | Apple touch icon generated from the exact approved favicon master with no redraw. | Home-screen icon on every public page |
...
| `assets/og-why-gutters-overflow-dayton-ohio.jpg` | JPEG, 1200x630 | ~183 KB | **CleanFlow of Ohio article card** composed from the authentic, owner-supplied, publication-approved `12977.jpg` flow-testing photograph with a deterministic blue-and-gold text treatment. The photograph was cropped and color-treated for legibility; no person, property condition, or job result was fabricated. | Page-specific `og:image` and `twitter:image` for `/resources/why-gutters-overflow-dayton-ohio` |
...
| `assets/og-underground-drainage-v2.png` | PNG, 1200x630 | ~1.1 MB | **Owner-approved, AI-assisted CleanFlow of Ohio page-specific promotional artwork**, using the owner's approved mascot and corrected underground-drainage visual direction. The versioned filename forces social-preview systems to request the replacement instead of reusing the prior cached asset. | Page-specific `og:image` and `twitter:image` for `/services/underground-downspout-drainage` |
...
| `assets/work/overflowing-gutters/cleanflow-gutter-flow-test.webp` | WebP, 1200x676 | ~165 KB | **Authentic CleanFlow of Ohio job photograph**, supplied and approved for publication by owner Casey Howard on 2026-08-14. Derived from `12977.jpg`; the visible person was also approved for publication. Auto-oriented, resized, and stripped of embedded metadata. | Resources hub card and article hero; cleaning and flow testing in progress |
| `assets/work/overflowing-gutters/gutter-debris-tree-cover.webp` | WebP, 865x1536 | ~275 KB | **Authentic CleanFlow of Ohio job photograph**, supplied and approved for publication by owner Casey Howard on 2026-08-14. Derived from `12984.jpg`; auto-oriented and stripped of embedded metadata. | Article example of debris accumulation and nearby tree cover |
| `assets/work/overflowing-gutters/cleared-gutter-outlet.webp` | WebP, 865x1536 | ~176 KB | **Authentic CleanFlow of Ohio job photograph**, supplied and approved for publication by owner Casey Howard on 2026-08-14. Derived from `12981.jpg`; auto-oriented and stripped of embedded metadata. | Article example of a cleared gutter outlet and downspout opening |
| `assets/work/overflowing-gutters/micro-mesh-guard-tree-cover.webp` | WebP, 865x1536 | ~364 KB | **Authentic CleanFlow of Ohio job photograph**, supplied and approved for publication by owner Casey Howard on 2026-08-14. Derived from `12972.jpg`; auto-oriented and stripped of embedded metadata. | Article example of gutter-guard maintenance under tree cover |
| `assets/work/overflowing-gutters/covered-gutter-roof-intersection.webp` | WebP, 865x1536 | ~187 KB | **Authentic CleanFlow of Ohio job photograph**, supplied and approved for publication by owner Casey Howard on 2026-08-14. Derived from `12979.jpg`; auto-oriented and stripped of embedded metadata. | Article example of concentrated roof flow at a covered gutter intersection |
| `assets/work/overflowing-gutters/open-gutter-flush-test.webp` | WebP, 865x1536 | ~317 KB | **Authentic CleanFlow of Ohio job photograph**, supplied and approved for publication by owner Casey Howard on 2026-08-14. Derived from `12975.jpg`; auto-oriented and stripped of embedded metadata. | Article example of cleaning and open-gutter flow testing |
