...
| `assets/og-underground-drainage.png` | PNG, 1200x630 | ~1.1 MB | **Owner-approved, AI-assisted CleanFlow of Ohio page-specific promotional artwork**, using the owner's approved mascot and underground-drainage visual direction. | Page-specific `og:image` and `twitter:image` for `/services/underground-downspout-drainage` |
